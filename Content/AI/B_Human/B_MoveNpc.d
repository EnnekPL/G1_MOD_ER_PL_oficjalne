...
func void B_MoveNpc()
{
	...
	if(other.aivar[AIV_INVINCIBLE] == FALSE)
	{
		...
		else if(((Npc_GetAttitude(self,other) == ATT_ANGRY) || (Npc_GetAttitude(self,other) == ATT_NEUTRAL)) && C_AmIStronger(self,other) && !C_NpcIsGuard(self) && !C_NpcIsGuardArcher(self) && (self.aivar[AIV_WASDEFEATEDBYSC] == FALSE))
		{
			B_FullStop(self);
			B_SmartTurnToNpc(self,other);
