...
////////////////////////////////////////////////////////
// KLUCZ DO SKRYZNI Z BRONIĄ DLA BUNTOWNIKÓW
...
INSTANCE ItMi_KeyFromRufus (C_Item)
{
	...
	description			= 	name;	
	TEXT[1]				= 	"Otwiera skrzynię w chacie w Kotle.";
};
...
{	
	...
	TEXT[2]				= 	"z bronią dla buntowników.";
};
...
{   
		...
		nDocID = 	Doc_Create		()			  ;								// DocManager 
					...
					Doc_PrintLines	( nDocID,  0, "Dogadałem się z Okylem i pozwolił mi składować stare kilofy i miecze. Powiedziałem mu, że chcę je później wysłać do kowala w celu naprawy. To naprawdę dobra przykrywka. Nic lepszego nie mogłem dla was zdobyć. Gdybym podkradał rynsztunek Najemnikom, natychmiast by mnie zabili.");
...
INSTANCE ItMi_KeyToChestInStorage (C_Item)
{
	...
	description			= 	name;	
	TEXT[1]				= 	"Otwiera skrzynię w magazynie ryżu.";
};
...
instance ItMi_RicelordRing(C_Item)
{
	...
	description		= " Pierścień Ryżowego Księcia";
	//TEXT[0]			= "";
	//TEXT[1]			= "";
	////COUNT[1]		= ;
